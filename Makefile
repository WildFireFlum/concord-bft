...
CONCORD_BFT_CMAKE_FLAGS?= \
			-DCMAKE_C_COMPILER=${CONCORD_BFT_CONTAINER_CC} \
			-DCMAKE_CXX_COMPILER=${CONCORD_BFT_CONTAINER_CXX} \
...
CONCORD_BFT_ADDITIONAL_RUN_PARAMS?=--env CONCORD_BFT_ROOT=${CONCORD_BFT_TARGET_SOURCE_PATH}
